...
\item \html{[} M. Borgonovo & M. Quadrio, 2009.
...
Report DIA-SR 04-15 Dipartimento di Ingegneria Aerospaziale del Politecnico di Milano.

\item \html{[}M. Quadrio, J.M. Floryan & P. Luchini, 2004. 
Effects of streamwise-periodic wall transpiration on turbulent friction drag.\html{]}
Report DIA-SR 04-11 Dipartimento di Ingegneria Aerospaziale del Politecnico di Milano.

\item \html{[} P. Luchini & M. Quadrio, 2004. 
A low-cost parallel implementation of direct numerical simulation of wall turbulence.\html{]}
Report DIA-SR 04-10  Dipartimento di Ingegneria Aerospaziale del Politecnico di Milano.

\item \html{[}M. Quadrio & P. Ricco, 2004. 
Critical assessment of turbulent drag reduction through spanwise wall oscillations.\html{]}
Report DIA-SR 04-09  Dipartimento di Ingegneria Aerospaziale del Politecnico di Milano.

\item \html{[}M. Quadrio, J.M. Floryan & P. Luchini, 2004. 
Modification of Turbulent Flow using Distributed Suction.\html{]}
Report DIA-SR 04-08  Dipartimento di Ingegneria Aerospaziale del Politecnico di Milano.

\item \html{[}M.Quadrio & P.Ricco, 2002. 
Reduction of turbulent friction by spanwise wall oscillations.\html{]}
Report DIA-SR 02-15, Dipartimento di Ingegneria Aerospaziale del Politecnico di Milano.

\item \html{[}M.Quadrio & P.Ricco, 2002.
Initial transient of a turbulent channel flow with spanwise wall oscillations.\html{]}
Report DIA-SR 02-14, Dipartimento di Ingegneria Aerospaziale del Politecnico di Milano.

\item \html{[}M.Quadrio & P.Luchini, 2002.
Direct numerical simulation of the turbulent flow in a pipe with annular cross-section.\html{]}
Report DIA-SR 02-12, Dipartimento di Ingegneria Aerospaziale del Politecnico di Milano.

\item \html{[}P.Morandi & M.Quadrio, 2001.
On the numerical solution of the Navier--Stokes equations in cylindrical coordinates.\html{]}
Report DIA-SR 01-01, Dipartimento di Ingegneria Aerospaziale del Politecnico di Milano.

\item \html{[}P.Ferrari-Trecate & M. Quadrio, 1994.
A pseudospectral method for the numerical solution of the Navier--Stokes equations.\html{]}
Report DIA-SR 94-02, Dipartimento di Ingegneria Aerospaziale del Politecnico di Milano.

\item \html{[}M.Quadrio & L.Vigevano, 1994.
Thermochemical model of a cement kiln.\html{]}
Report DIA-SR 94-01, Dipartimento di Ingegneria Aerospaziale del Politecnico di Milano.

\item \html{[}M.Quadrio, 1992.
Riduzione di resistenza di attrito in correnti turbolente.\html{]}
Report DIA-SR 92-30, Dipartimento di Ingegneria Aerospaziale del Politecnico di Milano.

\item\html{[}M.Quadrio, 1990.
Experimental investigation of turbulent structure modification on smooth and ribletted surfaces.\html{]}
Report 1990-16/AR, Von K\'arm\'an Institute for Fluid Dynamics (B).
